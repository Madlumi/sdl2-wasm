...
var ASM_CONSTS = {
 ...
 133896: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 133979: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 134048: () => { return window.innerWidth; },  
 134078: () => { return window.innerHeight; }
};
